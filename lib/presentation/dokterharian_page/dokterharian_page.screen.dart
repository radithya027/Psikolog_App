...
import 'controllers/dokterharian_page.controller.dart';

class DokterharianPageScreen extends GetView<DokterharianPageController> {
  const DokterharianPageScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: AppColor.blue500.withOpacity(0.3)),
                ),
      ...
      body: Obx(() {
        ...
        final displayList = controller.selectedFilter.value == 'Semua'
            ? controller.allDoctorList
            : controller.filteredDoctorList;
